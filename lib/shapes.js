...
class Triangle extends Shapes {
    render () {
        ...
        <text x="150" y="170" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.logoName}</text>
...
class Square extends Shapes {
    render () {
        ...
        <rect x="160" y="100" width="300" height="300" stroke="black" fill="${this.shapeColor}" stroke-width="5"/>

        <text x="225" y="170" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.logoName}</text>
